    ...
    public partial class AuditLog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_workspaces_audit_log", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_workspaces_audit_log_entity_id",
                table: "workspaces_audit_log",
                column: "entity_id");

            migrationBuilder.CreateIndex(
                name: "ix_workspaces_audit_log_tenant_id",
                table: "workspaces_audit_log",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_workspaces_audit_log_tenant_id_at",
                table: "workspaces_audit_log",
