    ...
    public partial class AuditLog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_tenancy_audit_log", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_tenancy_audit_log_entity_id",
                table: "tenancy_audit_log",
                column: "entity_id");

            migrationBuilder.CreateIndex(
                name: "ix_tenancy_audit_log_tenant_id",
                table: "tenancy_audit_log",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "ix_tenancy_audit_log_tenant_id_at",
                table: "tenancy_audit_log",
