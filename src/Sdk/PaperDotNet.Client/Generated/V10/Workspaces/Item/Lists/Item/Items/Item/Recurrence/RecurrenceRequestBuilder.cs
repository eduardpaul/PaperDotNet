...
using System;
namespace PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence.RecurrenceRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecurrenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1.0/workspaces/{%2Did}/lists/{listId}/items/{itemId}/recurrence", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence.RecurrenceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecurrenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1.0/workspaces/{%2Did}/lists/{listId}/items/{itemId}/recurrence", rawUrl)
        {
        }
...
#nullable restore
        ...
        public async Task<global::PaperDotNet.Client.Models.RecurrenceResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::PaperDotNet.Client.Models.RecurrenceResponse>(requestInfo, global::PaperDotNet.Client.Models.RecurrenceResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <returns>A <see cref="global::PaperDotNet.Client.Models.RecurrenceResponse"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence.RecurrenceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence.RecurrenceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PaperDotNet.Client.V10.Workspaces.Item.Lists.Item.Items.Item.Recurrence.RecurrenceRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
