...
#nullable restore
        ...
        /// <returns>A <see cref="global::PaperDotNet.Client.Models.ItemResponse"/></returns>
        /// <param name="body">PATCH body (documented shape; the handler reads raw JSON to tell a missing `parentId` from null): `fields`are merged (null removes a value), `parentId` moves the item (null: the list root).</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::PaperDotNet.Client.Models.ItemResponse?> PatchAsync(global::PaperDotNet.Client.Models.UpdateItemRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::PaperDotNet.Client.Models.ItemResponse> PatchAsync(global::PaperDotNet.Client.Models.UpdateItemRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::PaperDotNet.Client.Models.UpdateItemRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::PaperDotNet.Client.Models.UpdateItemRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
