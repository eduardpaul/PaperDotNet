...
using PaperDotNet.Client.V10.Groups.Item.Members.Item;
...
namespace PaperDotNet.Client.V10.Groups.Item.Members
{
    ...
    {
        /// <summary>Gets an item from the PaperDotNet.Client.v10.groups.item.members.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        /// <returns>A <see cref="global::PaperDotNet.Client.V10.Groups.Item.Members.Item.WithUserItemRequestBuilder"/></returns>
        public global::PaperDotNet.Client.V10.Groups.Item.Members.Item.WithUserItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("userId", position);
                return new global::PaperDotNet.Client.V10.Groups.Item.Members.Item.WithUserItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::PaperDotNet.Client.V10.Groups.Item.Members.MembersRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<global::PaperDotNet.Client.Models.UserResponse>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::PaperDotNet.Client.Models.UserResponse>(requestInfo, global::PaperDotNet.Client.Models.UserResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PostAsync(global::PaperDotNet.Client.Models.AddGroupMemberRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::PaperDotNet.Client.Models.AddGroupMemberRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::PaperDotNet.Client.Models.AddGroupMemberRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::PaperDotNet.Client.Models.AddGroupMemberRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::PaperDotNet.Client.V10.Groups.Item.Members.MembersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
