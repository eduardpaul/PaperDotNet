...
using System;
namespace PaperDotNet.Client.V10.Provisioning.Apply
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::PaperDotNet.Client.V10.Provisioning.Apply.ApplyRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1.0/provisioning/apply{?dryRun*,workspaceId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::PaperDotNet.Client.V10.Provisioning.Apply.ApplyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApplyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1.0/provisioning/apply{?dryRun*,workspaceId*}", rawUrl)
        {
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::PaperDotNet.Client.V10.Provisioning.Apply.ApplyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PaperDotNet.Client.V10.Provisioning.Apply.ApplyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PaperDotNet.Client.V10.Provisioning.Apply.ApplyRequestBuilder(rawUrl, RequestAdapter);
        }
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
