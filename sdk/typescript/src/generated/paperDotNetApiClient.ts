...
// @ts-ignore
import { type V10RequestBuilder, V10RequestBuilderNavigationMetadata } from './v10/index.js';
// @ts-ignore
...
/**
 * Instantiates a new {@link PaperDotNetApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createPaperDotNetApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<PaperDotNetApiClient>(requestAdapter, pathParameters, PaperDotNetApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface PaperDotNetApiClient extends BaseRequestBuilder<PaperDotNetApiClient> {
    /**
     * The v10 property
     */
    get v10(): V10RequestBuilder;
}
/**
 * Uri template for the request builder.
 */
export const PaperDotNetApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const PaperDotNetApiClientNavigationMetadata: Record<Exclude<keyof PaperDotNetApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    v10: {
        navigationMetadata: V10RequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
