...
// @ts-ignore
import { createApiProblemFromDiscriminatorValue, createItemResponseFromDiscriminatorValue, serializeItemResponse, serializeUpdateItemRequest, type ApiProblem, type ItemResponse, type UpdateItemRequest } from '../../../../../../../models/index.js';
// @ts-ignore
...
export interface WithItemItemRequestBuilder extends BaseRequestBuilder<WithItemItemRequestBuilder> {
     ...
     * @throws {ApiProblem} error when the service returns a 4XX or 5XX status code
     */
     patch(body: UpdateItemRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ItemResponse | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPatchRequestInformation(body: UpdateItemRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
