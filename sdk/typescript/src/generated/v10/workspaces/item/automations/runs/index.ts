...
// @ts-ignore
import { createPageOfRunResponseFromDiscriminatorValue, type PageOfRunResponse, type RunStatus } from '../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const RunsRequestBuilderUriTemplate = "{+baseurl}/v1.0/workspaces/{%2Did}/automations/runs{?automationId*,itemId*,status*}";
/**
