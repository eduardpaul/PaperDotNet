...
if TYPE_CHECKING:
    from .v10.v10_request_builder import V10RequestBuilder

class PaperDotNetApiClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new PaperDotNetApiClient and sets the default values.
    ...
    @property
    def v10(self) -> V10RequestBuilder:
        """
        The v10 property
        """
        from .v10.v10_request_builder import V10RequestBuilder

        return V10RequestBuilder(self.request_adapter, self.path_parameters)
