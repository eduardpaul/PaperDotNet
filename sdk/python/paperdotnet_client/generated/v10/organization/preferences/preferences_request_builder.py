...
class PreferencesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/organization/preferences", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PreferencesResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> PreferencesRequestBuilder:
        ...
        Returns: PreferencesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return PreferencesRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class PreferencesRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class PreferencesRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
