...
class SchemaRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/provisioning/schema", path_parameters)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        request_info.headers.try_add("Accept", "application/xml, application/problem+json")
        return request_info
    ...
    @dataclass
    class SchemaRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
