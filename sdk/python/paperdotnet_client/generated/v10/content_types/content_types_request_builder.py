...
class ContentTypesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/contentTypes", path_parameters)
    
    def by_id(self,id: UUID) -> ContentTypesItemRequestBuilder:
        """
        Gets an item from the paperdotnet_client.generated.v10.contentTypes.item collection
        ...
        return ContentTypesItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[ContentTypeResponse]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[ContentTypeResponse]]
        """
    ...
    def to_post_request_information(self,body: ContentTypeRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    @dataclass
    class ContentTypesRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
