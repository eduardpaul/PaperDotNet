...
class ItemsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/ext/samples.invoices/workspaces/{workspaceId}/lists/{listId}/items", path_parameters)
    
    def by_item_id(self,item_id: UUID) -> WithItemItemRequestBuilder:
        """
        Gets an item from the paperdotnet_client.generated.v10.ext.samplesInvoices.workspaces.item.lists.item.items.item collection
