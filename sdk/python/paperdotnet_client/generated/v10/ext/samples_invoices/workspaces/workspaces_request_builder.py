...
class WorkspacesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/ext/samples.invoices/workspaces", path_parameters)
    
    def by_workspace_id(self,workspace_id: UUID) -> WithWorkspaceItemRequestBuilder:
        """
        Gets an item from the paperdotnet_client.generated.v10.ext.samplesInvoices.workspaces.item collection
