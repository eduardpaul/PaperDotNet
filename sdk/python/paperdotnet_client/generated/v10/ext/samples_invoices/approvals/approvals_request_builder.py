...
class ApprovalsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[ApprovalResponse]]:
        ...
        return await self.request_adapter.send_collection_async(request_info, ApprovalResponse, None)
    ...
    @dataclass
    class ApprovalsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
