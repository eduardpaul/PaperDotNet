...
class WorkflowsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/workspaces/{%2Did}/automation/workflows", path_parameters)
    
    def by_id(self,id: UUID) -> WorkflowsItemRequestBuilder:
        """
        Gets an item from the paperdotnet_client.generated.v10.workspaces.item.automation.workflows.item collection
        ...
        return WorkflowsItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[WorkflowResponse]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[WorkflowResponse]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, WorkflowResponse, None)
    ...
    @dataclass
    class WorkflowsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
