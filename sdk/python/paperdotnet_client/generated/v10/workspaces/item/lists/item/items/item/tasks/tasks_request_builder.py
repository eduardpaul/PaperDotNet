...
class TasksRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/workspaces/{workspaceId}/lists/{listId}/items/{itemId}/tasks", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MyTasksResponse]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MyTasksResponse]
        """
    ...
    async def post(self,body: TaskFromDocumentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MyTask]:
        ...
        return await self.request_adapter.send_async(request_info, MyTask, error_mapping)
    ...
    def to_post_request_information(self,body: TaskFromDocumentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        param body: Creates a task about a document (TSK-06): in `workspaceId`/`listId` (a task list).
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
