...
if TYPE_CHECKING:
    ...
    from ........models.delta_page import DeltaPage
...
class DeltaRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/workspaces/{workspaceId}/lists/{listId}/items/delta{?%24deltatoken*,%24skiptoken*,%24top*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[DeltaRequestBuilderGetQueryParameters]] = None) -> Optional[DeltaPage]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[DeltaPage]
        """
        ...
        return await self.request_adapter.send_async(request_info, DeltaPage, error_mapping)
