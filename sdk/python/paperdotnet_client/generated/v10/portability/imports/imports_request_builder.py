...
class ImportsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/portability/imports{?dryRun*,workspaceId*}", path_parameters)
    
    async def post(self,body: bytes, request_configuration: Optional[RequestConfiguration[ImportsRequestBuilderPostQueryParameters]] = None) -> Optional[ImportResponse]:
        """
    ...
    @dataclass
    class ImportsRequestBuilderPostQueryParameters():
    ...
    @dataclass
    class ImportsRequestBuilderPostRequestConfiguration(RequestConfiguration[ImportsRequestBuilderPostQueryParameters]):
        """
