...
class MeRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: UpdateMeRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MeResponse]:
        """
    ...
    def to_patch_request_information(self,body: UpdateMeRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        param body: What users change on their own profile; the email and user name are managed by administrators.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
