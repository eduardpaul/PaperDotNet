...
class TermsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/termStore/terms{?ids*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[TermsRequestBuilderGetQueryParameters]] = None) -> Optional[list[TermResponse]]:
        """
