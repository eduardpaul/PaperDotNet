...
class ImportRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1.0/termStore/groups/{groupId}/import", path_parameters)
    
    async def post(self,body: bytes, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TermSetImportResponse]:
        """
        param body: Binary request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TermSetImportResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, TermSetImportResponse, error_mapping)
    ...
    def to_post_request_information(self,body: bytes, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        request_info.set_stream_content(body, "text/csv")
        return request_info
