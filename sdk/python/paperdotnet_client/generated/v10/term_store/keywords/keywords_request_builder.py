...
class KeywordsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new KeywordsRequestBuilder and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[KeywordsRequestBuilderGetQueryParameters]] = None) -> Optional[list[TermResponse]]:
        ...
        Returns: Optional[list[TermResponse]]
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[KeywordsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: KeywordRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def with_url(self,raw_url: str) -> KeywordsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: KeywordsRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class KeywordsRequestBuilderGetRequestConfiguration(RequestConfiguration[KeywordsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class KeywordsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
