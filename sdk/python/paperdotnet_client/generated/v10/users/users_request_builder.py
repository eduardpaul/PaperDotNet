...
class UsersRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UsersRequestBuilderGetQueryParameters]] = None) -> Optional[PageOfUserResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, PageOfUserResponse, error_mapping)
