...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[RoleAssignmentResponse]]:
        ...
        Returns: Optional[list[RoleAssignmentResponse]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, RoleAssignmentResponse, error_mapping)
    
    async def post(self,body: RoleAssignmentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RoleAssignmentResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, RoleAssignmentResponse, error_mapping)
    ...
    def to_post_request_information(self,body: RoleAssignmentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
