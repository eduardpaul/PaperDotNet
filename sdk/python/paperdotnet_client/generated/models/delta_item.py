...
if TYPE_CHECKING:
    from .delta_removed import DeltaRemoved
    from .json_object import JsonObject

@dataclass
class DeltaItem(AdditionalDataHolder, Parsable):
    """
    ...
    removed: Optional[DeltaRemoved] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeltaItem:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "@removed": lambda n : setattr(self, 'removed', n.get_object_value(DeltaRemoved)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("@removed", self.removed)
