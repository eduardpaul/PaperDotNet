...
@dataclass
class WorkflowStep(AdditionalDataHolder, Parsable):
    """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "else": lambda n : setattr(self, 'else_', n.get_collection_of_object_values(WorkflowStep)),
            ...
            "then": lambda n : setattr(self, 'then', n.get_collection_of_object_values(WorkflowStep)),
