...
if TYPE_CHECKING:
    from .delta_item import DeltaItem

@dataclass
class DeltaPage(AdditionalDataHolder, Parsable):
    ...
    # The value property
    value: Optional[list[DeltaItem]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeltaPage:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(DeltaItem)),
        }
        return fields
