...
@dataclass
class SmartFolderRequest(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SmartFolderRequest:
        """
