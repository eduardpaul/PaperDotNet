...
if TYPE_CHECKING:
    from .http_validation_problem_details_errors import HttpValidationProblemDetails_errors

@dataclass
class HttpValidationProblemDetails(APIError, AdditionalDataHolder, Parsable):
    ...
    # The errors property
    errors: Optional[HttpValidationProblemDetails_errors] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> HttpValidationProblemDetails:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "errors": lambda n : setattr(self, 'errors', n.get_object_value(HttpValidationProblemDetails_errors)),
